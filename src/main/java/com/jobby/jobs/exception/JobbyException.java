package com.jobby.jobs.exception;

import com.jobby.jobs.config.PropertiesConfig;
...
@Component
public class JobbyException {

    private static PropertiesConfig propertiesConfig;

    @Autowired
    public JobbyException(PropertiesConfig propertiesConfig) {
        JobbyException.propertiesConfig = propertiesConfig;
    }
